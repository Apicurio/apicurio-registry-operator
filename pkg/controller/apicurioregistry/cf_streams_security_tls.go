...
var _ ControlFunction = &StreamsSecurityTLSCF{}
...
func NewStreamsSecurityTLSCF(ctx *Context) ControlFunction {
...
func (this *StreamsSecurityTLSCF) AddSecretVolumePatch(deploymentEntry ResourceCacheEntry, secretName string, volumeName string) {
...
func (this *StreamsSecurityTLSCF) AddSecretMountPatch(deploymentEntry ResourceCacheEntry, volumeName string, mountPath string) {
	deploymentEntry.ApplyPatch(func(value interface{}) interface{} {
		deployment := value.(*apps.Deployment).DeepCopy()
