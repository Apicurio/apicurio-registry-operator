...
The recommended persistence option requires that you provide a connection information to a Kafka cluster. Although any Kafka cluster with Kafka Streams support
