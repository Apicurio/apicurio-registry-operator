...
| -
| -
| Configuration for HTTPS. See xref:ROOT:assembly-registry-maintenance.adoc#registry-https-in-cluster[Configuring an HTTPS connection to {registry} from inside the OpenShift cluster] for more details.
...
| _empty_
| Configure a list of environment variables to be provided to the {registry} pod. See xref:ROOT:assembly-registry-maintenance.adoc#manage-registry-environment-variables[Managing {registry} environment variables] for more details.
...
| -
| -
| Section to configure how the {operator} manages Kubernetes resources. See xref:ROOT:assembly-operator-configuration.adoc#managed-resources[{registry} managed resources] for more details.
...
| _empty_
| Configure parts of the {registry} deployment resource. See xref:ROOT:assembly-registry-maintenance.adoc#pod-spec[Configuring {registry} deployment using `PodTemplate`] for more details.
