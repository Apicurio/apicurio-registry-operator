...
= Securing the {registry} API and web console using {keycloak}

The following procedure shows how to configure a {registry} deployment to be protected by {keycloak}.
