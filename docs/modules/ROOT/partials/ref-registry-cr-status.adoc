[#status]
= {registry} custom resource - Status

This is the section of the CR, managed by the {operator}, that contains a description of the current deployment and application state.
