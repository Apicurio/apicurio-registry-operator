...
This chapter explains how to install {operator} on Kubernetes or OpenShift. It also shows how to install the {kafka-streams} or Java Persistence API (PostgreSQL) storage option: 
