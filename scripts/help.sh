#!/usr/bin/env bash
  ...
  echo -e "\nCommands: "
  echo "  make build OPERATOR_IMAGE_REPOSITORY=<OPERATOR_IMAGE_REPOSITORY>"
  echo "  make deploy OPERATOR_IMAGE_REPOSITORY=<OPERATOR_IMAGE_REPOSITORY> OPERATOR_NAMESPACE=<OPERATOR_NAMESPACE>"
